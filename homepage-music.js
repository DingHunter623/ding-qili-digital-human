    ...
    function installNavigationFeedback(doc) {
      ...
      if (!doc.getElementById('qilyLeanNavigationFeedbackStyle')) {
        ...
        style.textContent =
          ...
          '}' +
          'a.qilyLean-nav-target:hover,a.qilyLean-nav-target:focus-visible,a.qilyLean-nav-target.qilyLean-nav-pressed{' +
            'text-decoration-color:currentColor;' +
          '}' +
          'a.qilyLean-nav-target:hover::after,a.qilyLean-nav-target:focus-visible::after,a.qilyLean-nav-target.qilyLean-nav-pressed::after{' +
            'transform:scaleX(1);' +
          '}' +
          ...
          '}' +
          '.qilyLean-nav-target:focus-visible{' +
            'outline:3px solid rgba(23,139,148,.88);outline-offset:4px;' +
          '}' +
          '.qilyLean-nav-target:active{' +
      ...
      try {
        var FeedbackObserver = doc.defaultView.MutationObserver;
        var feedbackObserver = new FeedbackObserver(function (records) {
        ...
        feedbackObserver.observe(doc.documentElement, { childList: true, subtree: true });
      } catch (error) {}
    }
