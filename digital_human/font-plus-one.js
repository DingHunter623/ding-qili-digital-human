(function(){
  ...
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',function(){load('homepage-depth.js?v=depth2','homepageDepthScript');load('content-restore.js?v=restore-entries2','contentRestoreScript')});
  else{load('homepage-depth.js?v=depth2','homepageDepthScript');load('content-restore.js?v=restore-entries2','contentRestoreScript')}
})();